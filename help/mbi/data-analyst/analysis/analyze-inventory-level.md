---
title: 在庫レベルの分析
description: Adobe Commerce Intelligenceの現在の在庫量を監視するダッシュボードを構築する。 手順では、従来のアカウントと新しいアーキテクチャアカウントの両方の設定について説明します。
