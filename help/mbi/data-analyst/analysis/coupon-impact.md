...
次の項目に焦点を当てて、これらの質問に答えます。 [クーポン取得顧客と非クーポン取得顧客の比較](#compare), [クーポン取得からの最初の注文の詳細の分析](#firstorder)、および [クーポンを最初の注文で使用する顧客の属性を見てみましょう。](#attributes)
...
| **顧客獲得** | **新規顧客の数** | **平均生涯売上高** | **リピート注文数** | **クーポンを使用したリピート注文数** | **クーポン付きリピート注文の %** |
|-----|-----|-----|-----|-----|-----|
...
この節では、次の点にのみ焦点を当てます **クーポン獲得からの最初の注文（クーポンでセグメント化）。** 分析で次の指標を使用します。
...
| **クーポン** | **初回オーダー（FTO）** | **FTO からの総収益** | **FTO に適用される割引** | **FTO からの純売上高** | **FTO の平均注文額** |
|-----|-----|-----|-----|-----|-----|
| **100 ドル以上で 25% 割引** | 56 | $8,531.04 | $2,132.76 | $6,398.28 | 152.34 ドル |
...
* ビジネスによってクーポンが提供されたシーズン。
  ...
  **例：** 「20% オフ」のクーポンは夏の間に提供されましたが、ビジネスは冬服を販売しています。
* クーポンに関する制限。

  **例：** 「10% オフ」クーポンは、冬物のコートを同じ注文で購入したお客様にのみ提供されます。

この **総収益** 「100 ドル以上 25% オフ」クーポンの場合、「10 ドルオフ」クーポンの総売上高よりはるかに高くなります。 しかし、「$10 オフ」クーポンははるかに大きいです **注文数**. の分析 **平均注文額** では、これらの違いに関するインサイトを提供します。 「100 ドル以上 25% オフ」クーポンは注文数が少ないにもかかわらず、平均注文額は「10 ドルオフ」クーポンの 3 倍以上です。 したがって、総売上高が大きいのは、「100 ドル以上の 25% オフ」クーポンに起因します。

この **割引** および **純売上高** 「100 ドル以上 25% オフ」および「20% オフ」クーポンの価値は近いです。 「100 ドル以上で 25% オフ」の平均注文額は「20% オフ」の平均注文額の 2 倍に近いですが、後者のクーポンは注文数の 3 倍未満です。

## クーポンを最初の注文で使用する顧客の属性 {#attributes}

注文自体を見てみましょう。最初の注文でクーポンを使用している顧客を見てみましょう。

| **顧客の最初の注文クーポン** | **顧客の数** | **注文の平均ライフタイム数** | **平均生涯売上高** |
|-----|-----|-----|-----|
| **100 ドル以上で 25% 割引** | 56 | 2.8 | 554.54 ドル |
...
最も多かったのは、「20% オフ」クーポンを通じて獲得された顧客です。 ただし、これらの顧客の数は最も低くなります **注文の平均生涯数** および **平均生涯売上高**&#x200B;一般的に、クーポンを取得したほとんどの顧客は、リピート注文をしていません。 さらに、「100 ドル以上 25% オフ」クーポンを通じて獲得した顧客は、より高いドライブを駆動します **注文の平均生涯数** そして順番に、より高い **平均生涯売上高**. 一般的に、このクーポンを介して取得されたユーザーは通常戻ってきて、より多くの繰り返し購入をします。

## まとめ {#wrapup}

顧客によるクーポンの使用方法をより深く理解するために作成できる分析は多数あります。 顧客がクーポンをどのように使用するか、またはクーポンの使用にかかる時間を分析することを考えたことはありますか？ 最適な割引額を見つけることはどうですか – リピート購入者を促す金額、平均注文額の増加、生涯売上高の増加はどうなりますか？ これらのタイプの質問に関するヘルプ [サポートに連絡する](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies.html).
