...
新しいデータベーススキーマ、サーバー、またはレポートデータベースへの移行にストレスを感じる必要はありません。 [[!DNL Adobe]  サービスチーム &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies)は、移行支援を提供しています。
...
[&#x200B; サポートリクエストを送信](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies)することにより、当社に連絡できます。
