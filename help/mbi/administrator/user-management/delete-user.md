...
1. ユーザーを作成した後、[ サポートに通知](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies)します。 サポートは、ダッシュボードをアカウントに転送します。
