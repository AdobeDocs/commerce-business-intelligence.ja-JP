---
title: 'アカウントを削除しています [!DNL Commerce Intelligence] '
description: ' [!DNL Commerce Intelligence]  アカウントのクリーンアップ方法について説明します。'
...
![未使用のレポートリストで、どのダッシュボードにも存在しないレポートが表示されている](../../mbi/assets/unused_reports.png)
