...
- はじめに {#start}
   ...
   - [有効化対象 [!DNL On-Premise]](getting-started/onpremise-activation.md)
   - [有効化対象 [!DNL Cloud Starter]](getting-started/cloud-activation.md)
...
- 管理者 {#administrator}
   - アカウント管理 {#acct-mgmt}
      ...
      - [オフィスの周りにダッシュボードを表示](../mbi/administrator/account-management/display-dashboards-office.md)
...
- データを分析 {#analyze}
   ...
   - Data Warehouse管理 {#warehouse-manager}
      ...
      - [Data Warehouseビューの作成と使用](data-analyst/data-warehouse-mgr/create-dw-views.md)
   ...
   - SQLReport Builder {#sql}
      ...
      - [列の違い [!DNL SQL] および [!DNL Data Warehouse Manager]](data-analyst/dev-reports/columns-sql-dwm.md)
   - データの接続 {#connecting}
      ...
      - [インポート [!DNL CJ Affiliate] （委員会合）マーケティングデータ](data-analyst/importing-data/connecting-data/import-cj-market-data.md)
      - [インポート [!DNL Linkshare] データ](data-analyst/importing-data/connecting-data/import-linkshare-data.md)
      - [インポート [!DNL MailChimp] データ](data-analyst/importing-data/connecting-data/import-mailchimp-data.md)
   ...
   - SaaS 統合 {#saas}
      ...
      - [予測 [!DNL Adobe Analytics] データ](data-analyst/importing-data/integrations/adobe-analytics-data.md)
      - [接続中 [!DNL Facebook Ads]](data-analyst/importing-data/integrations/facebook-ads.md)
      - [予測 [!DNL Facebook Ads] データ](data-analyst/importing-data/integrations/facebook-ads-data.md)
      - [接続中 [!DNL Google Adwords]](data-analyst/importing-data/integrations/google-adwords.md)
      - [予測 [!DNL Google Adword] データ](data-analyst/importing-data/integrations/google-adwords-data.md)
      ...
      - [予測 [!DNL Google Analytics Warehoused] データ](data-analyst/importing-data/integrations/google-analytics-warehoused-data.md)
      - [接続中 [!DNL Google Analytics]](data-analyst/importing-data/integrations/google-analytics.md)
      - [予測 [!DNL Google Analytics] データ](data-analyst/importing-data/integrations/google-analytics-data.md)
      - [接続中 [!DNL Google ECommerce]](data-analyst/importing-data/integrations/google-ecommerce.md)
      - [予測 [!DNL Google ECommerce] データ](data-analyst/importing-data/integrations/google-ecommerce-data.md)
      - [接続中 [!DNL Mixpanel]](data-analyst/importing-data/integrations/mixpanel.md)
      - [予測 [!DNL Mixpanel] データ](data-analyst/importing-data/integrations/mixpanel-data.md)
      - [でのデータ検証 [!DNL Mixpanel]](data-analyst/importing-data/integrations/mixpanel-data-valid.md)
      ...
      - [予測 [!DNL Quickbooks] データ](data-analyst/importing-data/integrations/quickbooks-data.md)
      - [接続中 [!DNL Salesforce]](data-analyst/importing-data/integrations/salesforce.md)
      - [予測 [!DNL Salesforce] データ](data-analyst/importing-data/integrations/salesforce-data.md)
      - [接続中 [!DNL Spree]](data-analyst/importing-data/integrations/spree.md)
      - [予測 [!DNL Spree] データ](data-analyst/importing-data/integrations/spree-data.md)
      - [接続中 [!DNL Stripe]](data-analyst/importing-data/integrations/stripe.md)
      - [予測 [!DNL Stripe] データ](data-analyst/importing-data/integrations/stripe-data.md)
      ...
      - [予測 [!DNL Zendesk] データ](data-analyst/importing-data/integrations/exp-zendesk-data.md)
