...
description: の使用方法を学ぶ [!DNL Commerce Intelligence] Adobe Commerceで使用できる機能。
...
- はじめに {#start}
   ...
   - [のアクティベート [!DNL Commerce Intelligence] アカウント](getting-started/onpremise-activation.md)
   - [にログイン [!DNL Commerce Intelligence] アカウント](getting-started/sign-in.md)
   - [Commerce Intelligence Essentials とCommerce Intelligence Pro の比較](getting-started/essentials-vs-pro.md)
- 管理者 {#administrator}
   - アカウント管理 {#acct-mgmt}
      - [の利点 [!DNL New Architecture]](../mbi/administrator/account-management/new-architecture.md)
...
- データの分析 {#analyze}
   ...
   - Data Warehouse管理者 {#warehouse-manager}
      ...
      - [ビルド [!DNL Google Ecommerce] 寸法](data-analyst/data-warehouse-mgr/bldg-google-ecomm-dim.md)
      ...
      - [SQL 問合せの変換 [!DNL Commerce Intelligence] 報告書](data-analyst/dev-reports/sql-queries-reports.md)
   ...
   - SQL REPORT BUILDER {#sql}
      ...
      - [使用， [!DNL Cohort Report Builder] 日付ベース以外のコホートの場合](data-analyst/dev-reports/cohort-rpt-non-date-based.md)
   ...
   - データの接続 {#connecting}
      ...
      - [インポート [!DNL CJ Affiliate] （コミッション・ジャンクション）マーケティング・データ](data-analyst/importing-data/connecting-data/import-cj-market-data.md)
   ...
   - SaaS 統合 {#saas}
      ...
      - [次の範囲の結果について [!DNL Database] および [!DNL SQL] 編集者](data-analyst/importing-data/integrations/last-success-update.md)
   ...
   - データベースの統合 {#integration}
      ...
      - [を接続 [!DNL MySQL Database] 対象： [!DNL Commerce Intelligence]](data-analyst/importing-data/integrations/db-to-mbi.md)
      ...
      - [接続中 [!DNL MySQL] 経由 a [!DNL direct connection]](data-analyst/importing-data/integrations/mysql-via-a-direct-connection.md)
   ...
   - 顧客の分析 {#customers}
      ...
      - [ユーザー獲得ソース データの追跡の概要](data-analyst/analysis/google-track-user-acq.md)
...
- ベストプラクティス {#best-practices}
   - データの操作 {#data}
      ...
      - [最適化， [!DNL SQL] クエリ](best-practices/optimizing-your-sql-queries.md)
      - [について [!DNL Commerce Intelligence] 0.5511122](best-practices/understanding-magento.md)
   - プロジェクト組織 {#project}
      - [でのレポートと要素の命名 [!DNL Commerce Intelligence]](best-practices/naming-elements.md)
      - [テーブルの統合](best-practices/consolidating-your-tables.md)
      - [あなたの決定 [!DNL Commerce Intelligence] アカウント](best-practices/declutter-account.md)
...
- Tutorials {#tutorials}
   ...
   - [での時間オプションの使用 [!DNL Visual Report Builder]](tutorials/time-options-visual-rpt-bldr.md)
   - [からビジュアライゼーションを作成する [!DNL SQL] クエリ](tutorials/create-visuals-from-sql.md)
